...
public class System_out_printf {
	...
	public static void main(String[] args) {
		...
		account2.userName = "ntoanh";
		account2.fullName = "Nnguyen thi oanh";
		account2.createDate = new Date(93, 10, 01);
		account2.gender = Gender.UNKNOW;

		Account account3 = new Account();
		account3.id = 3;
		account3.email = "hoangthai@gmail.com";
		account3.userName = "hoangthai";
...
//table (giống trong Database)
		System.out.printf("Id", "Fullname", "Email");
